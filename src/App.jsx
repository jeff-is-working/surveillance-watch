...
export default function SurveillanceAwarenessPage() {
  ...
  const toolkitFiles = [
    { name: 'Simplified Template', path: '/Template_download/flock_camera_records_request_SIMPLIFIED.md', filename: 'Simplified_Template.md' },
    { name: 'Comprehensive Template', path: '/Template_download/flock_camera_records_request_template.md', filename: 'Comprehensive_Template.md' },
    { name: 'Complete How-To Guide', path: '/Template_download/HOW_TO_GUIDE_public_records_requests.md', filename: 'How_To_Guide.md' },
    { name: 'Quick Start Guide', path: '/Template_download/QUICK_START_one_page_guide.md', filename: 'Quick_Start_Guide.md' },
    { name: 'Legal Context Document', path: '/Template_download/LEGAL_CONTEXT_surveillance_cameras.md', filename: 'Legal_Context.md' },
    { name: 'Email Templates', path: '/Template_download/EMAIL_TEMPLATES_all_scenarios.md', filename: 'Email_Templates.md' },
    { name: 'Quick Reference', path: '/Template_download/QUICK_REFERENCE_surveillance_requests.md', filename: 'Quick_Reference.md' },
    { name: 'Toolkit Index', path: '/Template_download/TOOLKIT_INDEX_master_guide.md', filename: 'Toolkit_Index.md' }
  ];
            ...
            {activeTab === 'templates' && (
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-800 p-6 rounded-xl border-2 border-blue-500">
                  ...
                  <a 
                    href="/Template_download/flock_camera_records_request_SIMPLIFIED.md" 
                ...
                <div className="bg-slate-800 p-6 rounded-xl border-2 border-purple-500">
                  ...
                  <a 
                    href="/Template_download/flock_camera_records_request_template.md" 
            ...
            {activeTab === 'guides' && (
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-800 p-6 rounded-xl">
                  <h3 className="text-xl font-bold mb-3">[Book] Complete How-To Guide</h3>
                  <p className="text-gray-300 text-sm mb-4">
                    Step-by-step walkthrough with 7 detailed steps, troubleshooting, and Thurston County contacts.
                  </p>
                  <a 
                    href="/Template_download/HOW_TO_GUIDE_public_records_requests.md"
                ...
                <div className="bg-slate-800 p-6 rounded-xl">
                  <h3 className="text-xl font-bold mb-3">[Lightning] Quick Start Guide</h3>
                  <p className="text-gray-300 text-sm mb-4">
                    One-page printable reference card. Get started in 5 minutes.
                  </p>
                  <a 
                    href="/Template_download/QUICK_START_one_page_guide.md"
                ...
                <div className="bg-slate-800 p-6 rounded-xl">
                  <h3 className="text-xl font-bold mb-3">[Scale] Legal Context Document</h3>
                  <p className="text-gray-300 text-sm mb-4">
                    Deep dive into court ruling, UW report, and how to cite precedent in appeals.
                  </p>
                  <a 
                    href="/Template_download/LEGAL_CONTEXT_surveillance_cameras.md"
                ...
                <div className="bg-slate-800 p-6 rounded-xl">
                  <h3 className="text-xl font-bold mb-3">[Email] Email Templates</h3>
                  <p className="text-gray-300 text-sm mb-4">
                    10 ready-to-use templates for submission, follow-ups, appeals, and more.
                  </p>
                  <a 
                    href="/Template_download/EMAIL_TEMPLATES_all_scenarios.md"
